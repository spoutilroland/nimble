      ...
      <div className="max-w-[1200px] mx-auto px-5">
        ...
        <div className="about-content grid gap-16">
          <div className="about-text text-[1.1rem] leading-8 text-[var(--text-muted)] text-center max-w-[900px] mx-auto">
            <p className="mb-6" data-content-key="about-p1">
            ...
            <p className="mb-6" data-content-key="about-p2">
          ...
          <div className="about-features grid grid-cols-[repeat(auto-fit,minmax(280px,1fr))] gap-10">
            <div className="feature-card">
              ...
              <h3 className="font-['Oswald',sans-serif] text-[var(--primary-dark)] mb-4 text-[1.4rem] font-bold uppercase tracking-[1px]" data-content-key="feature-1-title">15+ ans d&apos;experience</h3>
              <p className="text-[var(--text-muted)] leading-[1.8]" data-content-key="feature-1-desc">
            ...
            <div className="feature-card">
              <div className="feature-icon text-[4rem] mb-6">&#10003;</div>
              <h3 className="font-['Oswald',sans-serif] text-[var(--primary-dark)] mb-4 text-[1.4rem] font-bold uppercase tracking-[1px]" data-content-key="feature-2-title">Materiaux nobles</h3>
              <p className="text-[var(--text-muted)] leading-[1.8]" data-content-key="feature-2-desc">
                Bois massif local, pierre de montagne, ardoise naturelle, toitures traditionnelles
              </p>
            </div>
            <div className="feature-card">
              <div className="feature-icon text-[4rem] mb-6">&#128188;</div>
              <h3 className="font-['Oswald',sans-serif] text-[var(--primary-dark)] mb-4 text-[1.4rem] font-bold uppercase tracking-[1px]" data-content-key="feature-3-title">Devis gratuit</h3>
              <p className="text-[var(--text-muted)] leading-[1.8]" data-content-key="feature-3-desc">
